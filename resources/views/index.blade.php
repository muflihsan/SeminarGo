...
<body>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
      <h1 class="mb-4 pb-0">Seminar Tech<br><span>Let's</span>Grow With Technology</h1>
      <p class="mb-4 pb-0">August , Aula Fatisda Universitas Sebelas Maret, Surakarta</p>
      <a href="https://www.youtube.com/watch?v=jBkfkESJjaQ" class="glightbox play-btn mb-4"></a>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
              Jl. Ir Sutami No.36, Kentingan, Kec. Jebres, Kota Surakarta <br>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>2023UNS</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
      ...
      -->
        Designed by <a href="https://bm/ootstrapmade.co">JulianDewanto</a>
      </div>
    </div>
  </footer><!-- End  Footer -->
