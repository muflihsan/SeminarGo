...
(function (c) {
    ...
    c.extend(m.prototype, {
                ...
                p =
                    ...
                    a.fnRecordsDisplay() == a.fnRecordsTotal()
                        ...
                        : b.sInfo
                          ...
                          b.sInfoPostFix;
                (b = b.fnInfoCallback) &&
                    (p = b.call(a.oInstance, a, e, d, l, n, p));
                e = a.aanFeatures.i;
                if ("undefined" != typeof e)
                    for (l = 0, n = e.length; l < n; l++) c(e[l]).html(p);
        ...
        _parseHeight: function (a) {
            ...
            "px" === d
                ...
                : "em" === d &&
                  (b = a * parseFloat(c("body").css("font-size")));
            return b ? b : 0;
        },
        _scroll: function () {
            var a = this,
            ...
            if (
                ...
                if (this.s.dt.bFiltered || this.s.dt.bSorted)
                    ...
                    this.s.scrollType =
                        Math.abs(d - this.s.lastScrollTop) > b.viewport
                            ? "jump"
                            : "cont";
                    this.s.topRowFloat =
    ...
    q.register("scroller().rowToPixels()", function (a, b, d) {
        ...
        if (e.length && e[0].oScroller)
            return e[0].oScroller.rowToPixels(a, b, d);
    });
    q.register("scroller().pixelsToRow()", function (a, b, d) {
        var e = this.context;
        if (e.length && e[0].oScroller)
            return e[0].oScroller.pixelsToRow(a, b, d);
    });
    q.register(
